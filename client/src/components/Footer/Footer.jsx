...
const Footer = () => {
  ...
  return (
    <footer className='py-2 md:absolute md:bottom-0 left-0 w-full bg-gray-800 text-white sm:py-4 px-2'>
    <div className="container mx-auto flex items-center justify-between text-xs md:text-sm lg:text-lg xl:text-xl">
