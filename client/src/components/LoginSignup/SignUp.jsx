...
const SignUp = ({showLogin, setShowLogin}) => {
  ...
  console.log(watchFields.password === '')
  ...
  return (
    <div className="flex h-1/2 mx-auto bg-slate-700 rounded-lg shadow-2xl justify-between">
      {/* Error message */}
      {/* The Form */}
      <div className="p-6 flex-2 flex flex-col justify-center max-w-fit md:px-6 rounded-l items-center">
        <h1 className="mb-6 text-center md:text-start self-start">
        ...
        <div className="mt-10">
          <p className="font-cata text-white text-sm lg:text-lg">
            ...
            <span className="text-purple-400 italic hover:cursor-pointer hover:text-purple-300" onClick={(showLogin)=>setShowLogin(true)}>
              Login
            </span>
          </p>
        </div>
